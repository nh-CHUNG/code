...
def Level_Column_Adding_Function(input_path):
    ...
    ##### 작업 완료 파일 저장
    input_path = input_path[0:-5] + "_LEVEL.xlsx"
...
button___open_file = tk.Button(root, text="Select File", command=open_file)
...
button___Level_Column_Adding_Function = tk.Button(root, text="Level Column Adding", command=Level_Column_Adding_file)
